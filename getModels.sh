...
./wget.exe -c ${OPENPOSE_URL}${COCO_MODEL} -P ${COCO_FOLDER}
...
./wget.exe -c ${OPENPOSE_URL}${MPI_MODEL} -P ${MPI_FOLDER}

# "------------------------- FACE MODELS -------------------------"
# Face
FACE_MODEL=${FACE_FOLDER}"pose_iter_116000.caffemodel"
./wget.exe -c ${OPENPOSE_URL}${FACE_MODEL} -P ${FACE_FOLDER}

# "------------------------- HAND MODELS -------------------------"
# Hand
HAND_MODEL=$HAND_FOLDER"pose_iter_102000.caffemodel"
./wget.exe -c ${OPENPOSE_URL}${HAND_MODEL} -P ${HAND_FOLDER}
